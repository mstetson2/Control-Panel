...
void engine_controller() {
	button_states();
}

//reads each button state
void button_states() {
	boolean troublePressed, estopPressed, panelOn,
		modeAuto, modeManual, modeBypass,
		ridestartPressed, ridestopPressed, functionEnabled,
		typeOne, typeTwo, typeThree,
		acknowledgePressed, restraintPressed, dispatchLPressed,
		dispatchRPressed, dispatchPressed, gatesOpen,
		esrPressed, hmiPressed, opsPressed;
	int mode, type;
	...
	//sends button states for global use
	buttonClass::button_state_comm(troublePressed, estopPressed, panelOn,
		modeAuto, modeManual, modeBypass, esrPressed, functionEnabled,
		typeOne, typeTwo, typeThree,
		ridestartPressed, ridestopPressed,
		acknowledgePressed, opsPressed, restraintPressed, dispatchLPressed,
		dispatchRPressed, dispatchPressed, gatesOpen, hmiPressed);
		
}


boolean m100, m250, m500, m1000;
long p100, p250, p500, p1000;
void blink100() {
